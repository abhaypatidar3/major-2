...
const RISK_PROMPT = `You are a menstrual health risk analyst AI embedded in a women's health platform called NariCare.
...
- Always recommend consulting a Gynecologist for anything flagged moderate or high.
...
Respond ONLY with a valid JSON object, no markdown, no extra text:
{
  ...
  "disclaimer": "This analysis is generated by AI based on self-reported data and is not a medical diagnosis. Please consult a qualified Gynecologist for any health concerns."
}`;
...
export const getRiskPrediction = catchAsyncErrors(async (req, res, next) => {
  ...
  flowDays.forEach((l) => {
    ...
    if (!lastFlowDate || (d - lastFlowDate) / (1000 * 60 * 60 * 24) > 2) {
      distinctPeriods++;
    }
    lastFlowDate = d;
  });
